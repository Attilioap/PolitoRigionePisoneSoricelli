...
from .views import educator_dash, signup, user_login, student_dash, tournament_managment, tournament_status_page_educator, battle_status_page, tournament_status_page_student, battle_status_student
